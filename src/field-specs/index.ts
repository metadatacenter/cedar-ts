...
const FIELD_SPEC_KINDS = new Set<string>([
  ...
  'date_field_spec',
  'time_field_spec',
  'date_time_field_spec',
  'controlled_term_field_spec',
  'literal_single_choice_field_spec',
  'controlled_term_single_choice_field_spec',
  'literal_multiple_choice_field_spec',
  'controlled_term_multiple_choice_field_spec',
  'link_field_spec',
  'email_field_spec',
  'phone_number_field_spec',
  'orcid_field_spec',
  'ror_field_spec',
  'doi_field_spec',
  'pub_med_id_field_spec',
  'rrid_field_spec',
  'nih_grant_id_field_spec',
  'attribute_value_field_spec',
]);
